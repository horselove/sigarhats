<section class="section section--page">
  <div class="row ws-medium--bottom">
    ...
    <?= $this->Form->input( 'location', ['placeholder' => 'location','required'=>'true','value'=>(!empty($data['RegisteredCap']['location'])?$data['RegisteredCap']['location']:'')] ); ?>
    <?= $this->Form->input( 'birth', ['placeholder' => 'birth','value'=>(!empty($data['RegisteredCap']['birth'])?$data['RegisteredCap']['birth']:'')] ); ?>
    <?= $this->Form->input( 'gender', ['placeholder' => 'gender','required'=>'true','value'=>(!empty($data['RegisteredCap']['gender'])?$data['RegisteredCap']['gender']:'')] ); ?>
    <?= $this->Form->input( 'email', ['placeholder' => 'E-mail','required'=>'true','value'=>(!empty($data['RegisteredCap']['email'])?$data['RegisteredCap']['email']:'')] ); ?>
           ...
           {
               ?>
           <img src="<?php echo $this->webroot.$data['RegisteredCap']['image_url']; ?>" height="100" width="100" />
           <?php
           }
?>
